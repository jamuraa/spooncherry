...
browser_cmd = "google-chrome-unstable --force-device-scale-factor=1"
...
function()
  fh = assert(io.popen("acpi | cut -d, -f 2,3 - | cut -d: -f 1,2 -", "r"))
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,  "Control"}, "b", function () awful.spawn(browser_cmd) end,
